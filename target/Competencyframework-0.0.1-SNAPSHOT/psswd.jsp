...
<html lang="en">
<head>
	<title>Gesion des Compétences</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="psswdServlet" method="POST">
					<span class="login100-form-title">
						Récuperer vos identifiant 
					</span>
     <p>Veuillez saisir à nouveau  vos cordonnés afin de confirmer votre identité :</p>
